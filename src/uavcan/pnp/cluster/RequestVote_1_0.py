...
#
# Generated at:  2025-10-08 12:28:09.011250 UTC
# Is deprecated: no
# Fixed port ID: 391
...
class RequestVote_1_0:
    ...
    class Request:
        ...
        _MODEL_: _pydsdl_.DelimitedType = _restore_constant_(
            'ABzY8*;wXi0{@*=>u(!H5O>rxag(N`3QdbD(L+Em5;+=GfOz(i7Ew%saYK=)s%7tP;#uXqd+hFo7z9d+idtzUB4zo`pUUiA9?rvG'
    ...
    class Response:
        ...
        # is not dependent on PyDSDL.
        _MODEL_: _pydsdl_.DelimitedType = _restore_constant_(
            'ABzY8*;wXi0{@*<-)|d55VmO=r%6gvg{DQ7s4Gfp9(tq{2@2&`3YCzFu^gJJ60q94n|M|^?_PKJOpJuoK7bl&B_d^c=TBw!E=|rf'
    ...
    _MODEL_: _pydsdl_.ServiceType = _restore_constant_(
        'ABzY8*;wXi0{_icTW=gS6y8<SWSdKysx(DJ4O4-_7Mi6k65=M&CTXE8Nmpr!gamRuGtM5jv-aTegaipG6>2WX5|Luwfd_s7LgJMN'

...
#
# Generated at:  2025-09-11 16:20:08.400957 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Frame_0_1:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8xc0(m0{^{MTW=dh6n5GsancKJQ(AFTM^M@n(QQHj6{L!$#c5MF#yFu80yG_a$3EMvcULpBZd?h}f+$oP(Mp*@xji7BcmRo~'
        ...
        'R_JmAPwE4et|Pn6IfrZWcFA7Pr>2VGQmI(rGU2Xu^m$y<W9TVjbx(CnX+-a!HD4Niq#JI}7$aBf-;LgN)>G*vEZ}PvuHH_=$Y?Ui'
        'iR`p$q3_i(>3QA?@iG+F@~wyqrb5w6dW6=&!}@@u_f>hsmAARwHoAnd!%4JztQ`A36P@)&=&Q~An43FhvXs9oYnb^C+VTQZnz947'
        'YzL$ELSvs<ucaYtn!8)dr_UJgoG(WRPm8;9T(dr4SnqVXR9=vzV9=EtVqQ6eYlSpCn1BP>=m~f_8yza;fxuyS9!mg6F!-bJLb3$M'
        'VJfpZ39n?MQ%QEOrv|5cDZm@0DL8}wGn)kr#a@&nGK@tXv2q?R^o6!98x8BDThp*;2MH))6vn!&gI&n9HST)(6?*v%>*4hBv(xwJ'
        '{JAi&fLw*lR(t0v^zzHeUO26v>4FMtA-J@~=%Z1-npA@MUC+2@tRYz4&LXn&v)LHe=W}_RMb#viboIXi**;UPWMP2Fe8aW*kw<cp'
        'Wb^7KZvMX2bHnw-8Zo1_PO6mF9e@iVEWt-`9X^9kVpIl~<4x3=;;y-^_t1tFCTfdEJ=c`=UYgb(7ko}5hP>CK_ThUqqsJ<!(#sV)'
        'yMk02I)NC5&<gH|h=YI&e7_coC8G<d5=*Sf-Q%_Z$D@vc`+8i)wS+UMxu}?N4QWjUZz72>o}QfI>PU(&><4`a!;*9{X7s*QlsQw*'
        'v||r4%Ieny1tu|gVI>tcwCy37Z^L>0^FpR;WOXa4XW){AN#gQ`hpI|y9Wqxe7D<&iJ&C7V43L>vK`2oB2s$BiGvyg)d=WfJe6%6>'
        '3<Dq6h-@+6Czvbh7YQ3{PEf!U!LX7k&*cJ-QX#2vBCrFr(S|faLC$p|V7`O5n3OVYj{zo=wyKA@o3S1PxjvW_lB$r3FjR?8iS<E>'
        'txSS}d+;TE1^4myHGBi#+AG{#VNfwE%yqq>xj|OfDNX?u2b*w|T4N7N<fnl0Q?T;WRUNrjb;gqDlMc8+c=qdqml^g#?1O{4=s>-k'
        '&mGqLx-F$)dwAMr*OBho(vWR_>81hcKaNUdxf5*KgKT%SEeK&}>$KrQ`dl5XvY^SgYE&b1DQPtr{~$fj!I_IWGL+jw(z(oT{$gQk'
        '!>kHO_KqJi?4#%P^g<k2WJ!zHHsUYQN^&*Ej!YW%OG}c;II<9ajg-8z#~kcr9JI}G7WTq>FbBWE`|uC^9>W*6;Z7OuZVEa04!+lW'
        'l5e+uD#H(!wjU>4JT>)_b223^LOea6aI8lpt$<i<AD;_|;-V!j?NG5ITs)!bksG(77m<CIcmf*%vdQ8SO@bw2!C={YX|7yae791h'
        '#l;K7YPq<0;>}Bov{;^=nm_9p`0-(>H=KTha`@>H>GkXCs5kd#YWA1K)Bj~T4G&5~{oe}-Lg4KbOjmIBN^kZ-#_n~~zof<y&PHpE'
        'Q_t(B|45B*AWUy$Fzt7~Va3AL`4`6va_?IV000'
    )

...
#
# Source file:
# /home/runner/work/packaged-dsdl-py/packaged-dsdl-py/submodules/public_regulated_data_types/uavcan/si/unit/electric_charge/Scalar.1.0.dsdl
#
# Generated at:  2025-09-11 16:13:19.330842 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8AN9g$0{@LuO>Yx15KSRX`T?|2D>!hV7fLvEX@LS~ka`I%fui1!<z2h6RquM`kB}fL(E}AlmO$$8d&_u}l2TNO%^|kO^Jd<g'
        '=P&hNpX;^i3-`()vrHw#awDmdpJ=LhLNc9~+DgYE+}w4>XU-e`epqrig@;FQ2<<RU3Yug5zNh_+7KxRKFQiMj;+ZotBblJ4$CKTR'
        'Drz9ikUlq7>H<V9H222qQ|L@}YR7N{VV+QjiK%zo!UwpjwLh02Om9i9*rcU7!l<Lf#Xhe}FOAHllYP7~yQMUBf3un=sdPl~qUQv3'
        'RuD3y){$H@4q`dn?w+T|wB!}Wwqpos)V{(y2+PDeS}<zZMWAnplhYo`<5?`cZ)oO_zC~HK#%sj*-l|>v&d$ziovCAl^{JQ+%}jfx'
        '^AtjzFr7iD;W-UU7i1&pa5R-e5UZkPkq+af;Td(D!AZD9_T_*xQflLfWUv!j#A<Icjse9<NwL|`jDJdEq1i5)V9<@Hrzp<UBdjfS'
        'oO;9fqTo2z`bTXJAS{+NJD@$z)}rWZ<q*VXn6o}b<-EdyhP$Ot723k^o>#G-$*?fm7`X_-H7gM`ItjwUB`@L0$W6&cvYy03;G*bD'
        'L{N*(8(z3L?!L@8oQMaa9TqD+Mt&|Z9G%tv-)fDqcX_x|Nkg0_Mr&7LT4ao#SZ|9B@mM?&PsJwwo{8t;Mb%WDqzZ|xp4)I@2W-(@'
        '-b1+YQo7gGeiyf6Lx$@_mk?I20<pt9)u<|Ju+4LgCXZHnQ*uL{HWOPnkdwrxBHo6DE@ey>y?-u=y%^o`3MmgSM-ib<mFMsS+MSi3'
        'HpTZ`j)0&u<5Q%Y%ObuQT+l&WG)Xmk8nfpJAC$DHp8SqaZR*qHH&)$(bcX~000'
    )

...
#
# Source file:
# /home/runner/work/packaged-dsdl-py/packaged-dsdl-py/submodules/public_regulated_data_types/uavcan/si/unit/acceleration/Vector3.1.0.dsdl
#
# Generated at:  2025-09-11 16:13:19.352586 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Vector3_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8AN9g$0{@LvZBG<25MEx6<3$w2Xd)jZF){do6@$_E(YG^k0SPE7N=kQIt_{1}P1`*=6B79#5z|Bx#@~z6yTdzB68Cc1c4s>C'
        '%ro=!>)@~Fm7w*wTSb!@mWIS|Eomyh&^YBGNmN!SBP|CvzGiiq*i!R1&4R-*+}(#gm~|DB(+usmOWH_i9vT^zxwIio5}tBRtyFoq'
        '&J(Nj0=Qw);M(9P5P_?%ch<)c^+mw}?1LL4)LJd$(sBcva1pRSPT(pv$y3$^G)fq?lvt0_O<!<aYuW^NttNLlTjY7&iYNZl+0w=d'
        'R*>=Bc7k1irO+~yRyNRMq?Rgb&qf&|v9u&@C4p!L@g>w)k}1YP+;rDhPLKOz;WM-?c@uIHe1la4NsOgAqnh;w`i^ljT1Tc!<`Zvg'
        'ns}-Wa$M`IF~*O{p!YdBISHb^0}NZnZUli8G?BIm(SREyaf*lUoYvUQh2`4wdvKSYO50{`4Y!?Y-2hPqxS5NBm}VBMR3_l2mUyO+'
        'L67rw;par@E@wj|5fYm!9=NNkyx>;;+pnMOAa?N>{jMyRX-akTyc5Q1(6r?66K12CBNJoggCvtVL|cAAcm1O3`%$J84@7<5GdMEH'
        'FyAd`-Wt*6GWJJB#Z712a!oJ|)|9B6^(+A+GKJ*@NHBF%J;O}mW?LzHAR;koa4r}xG*77I3=Z98vh9bF6iQnn87#X=VpORUj)s(z'
        'f@0TQ)xT01W5-uen7b?f>oGFXcMo$5<&`+3%RJ{A_n(#C0XKn7-l28Q=6qA;iYAB+H)_hbRWiy9RZ_;-6{2|^IY2yJ388hUt!!}p'
        'Mq*H}Zft+AzA;Bf;o<#oKJ;n8`q`Z#f*ORby@*gX4ViE_6pLcXO|;l(-!M6vz1nC0D_8aOHsS6@ixy%P(Ms7?M1$3$u-?v!b@5KT'
        '7azn1{yvINV$(wsb7H<V7h*v?Y)?^pd{!u9GOzzNV`zPZ*H+OsLo|#-@FLn0HT=KCFt0k35&i~Jf5G-o1poj'
    )

...
#
# Source file:
# /home/runner/work/packaged-dsdl-py/packaged-dsdl-py/submodules/public_regulated_data_types/uavcan/si/unit/acceleration/Scalar.1.0.dsdl
#
# Generated at:  2025-10-27 13:51:00.266173 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8#CZQ`0{@Lv-%nF96dpQ$2r3YWKJXy%0p|l(P*I;X;bnqT3~#3CZOhuwdwbI#b2A~42T@EDO*sC&c)ATYF(lq)+37v)cfRwT'
        'ulrp8^|fB>Kk;7G<Bsc$IAIml>J!bi$Otn<Wt{Q?;;lVz1M|U(_q|HM89Y3OBWT1)QqltR_XF)PT4qjVp;SJjj0r6)^~#jl9;2FC'
        'h%=-ktiv}TYjJvi7@t9NqFFnEV~BHvdT&)8ym0UVuHyA)6U51FB{U!LnI)WhN_--D)$z)zLV4A}9XGbMq5kid=18tQ(V}d73C&f6'
        'WYl?57%o6A$2+Zy<LOxT3UfOtg>BTnz&nV`#CckBYWX<OH^eDu8?^~M6+W<(C2<_evOSCu<NIQ5{5d~AuQex55H{p;GOiTD3ri~e'
        'I>AiI$3lp8!VQC1!@V>vjY&!J-e62eAlKxg!xp)ytYFj&4yW-pIZ$1JV8(i)IPAtn;!LniU_uL0QEVVirys3yB;P_;bX)1|845P>'
        '2y07|Y%pa*SqdC={iCsm5Em-S4ryEP^)!g}st0l_&bpAJnnB}`<4P5Btr)SQ9dzO|8X#t;2DXBD%_#&;)`EC*+*}an2lmP~vyCiO'
        '0iUL@L?m^{+=|kt`F9i(a4H|jMqKENF>rT@>14IWf0ddVI$6ZKeNl)v#2VxKfDU^_hio+DrhF`)$ft4(KhNZI`J&ILPI8SctzDRM'
        'WDex#FR!uoOXXkp*L%1e+B04!rh>S76^QE<xj{WqfE`g7w0vUzrb;asJ2LqcVN&76k#FOCi*l~Y_CK5Ce#-6!jV<>sXAz-8brA3a'
        '8qL+8F2~zl4S=9I6LM^~P-VJ57|?DCrb&P5G@YI$qFd3j{|B%ea+ilZ`whQ{N~Dqm000'
    )

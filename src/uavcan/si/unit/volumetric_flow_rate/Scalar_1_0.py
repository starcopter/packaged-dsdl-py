...
#
# Source file:
# /home/runner/work/packaged-dsdl-py/packaged-dsdl-py/submodules/public_regulated_data_types/uavcan/si/unit/volumetric_flow_rate/Scalar.1.0.dsdl
#
# Generated at:  2025-09-11 16:20:08.654476 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8xc0(m0{@j%&rcLF6kc@sA*etgc<>-6Tum53MLlc6Wd&C;+)UF>%eJ92o%F}DYeFIiiI^su@VxlX;_L3>BFe#;Os1XJ_w{|>'
        '`#PWMKYrG0{VU$9dfaiH5htvoT79HUi;U!^sEkuyK)ki%ZODDF;(f0Ya0(BO;1C*doRqY{_`^UuIW04%vQR3Yb&L*$@K)tyPn!c`'
        'sTbK!PBpa<r$|Rwr%Va57AJRy<5OskHEYLk1aXE?kGU*(;ot*YRp0ML5XU!_(0o+aG~v`!;#09#rB_xJ%Bv2pxUs1X^?y>EAxwFq'
        'McMWen#%~8Q|C!xxB$5rms;oPDJ^@2v8@zB8nw^x4&owlo|c?iei7&k;uN%v8U>y<-m^6KNZ+9>o5L|;e4Vddyw1+fYR$1@gbhrN'
        '$E7?lR2BsmmQ?sSk(-i3tP^f>h&5bB<H7|M3F{3ybqI1r&O2nsMP)^fec^BtZ<9UM6`WMYdZIXN$9dvRu(`m17NnwBdz?%!tr*tb'
        'LSuAW>FX(KHTDSimL@r2!iKUG*yZ|xvHK9`Dw^-pw&1I&2dh;N<VKu!fuWE=V}Ik_Dlm<7tY`<F>KXM8qZ0#XLA>S^f+lyNw*T@M'
        '#Myzvvh{2&OS^$jjaVR(I%Hr)>5~OIDi?4f@5@G<>x(ildWqrWw#I*LIWaV~h<ExT5pRe!#`l38a!0eQHRQT{ET71yas%&Y^0|D`'
        'udGg(Mv5!v{v7!P>-3lB5O2Oz{&j!8gVUi?<8@*xh|5=jxL&~w>We~biNc`!lgHkmZKyYP<o5}ZOND1hzKydj%DF1re=U-`DY_jr'
        'Qtn-jB0`7iAmAG`n#<oE!-HN8fS@@Q7}70NnT`?;Xg3WeN#6xDWls~)t!UZ*7i<USSYX*N8rguLr33%~'
    )

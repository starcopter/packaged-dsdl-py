...
#
# Source file:
# /home/runner/work/packaged-dsdl-py/packaged-dsdl-py/submodules/public_regulated_data_types/uavcan/si/unit/force/Scalar.1.0.dsdl
#
# Generated at:  2025-09-11 16:13:19.337287 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Scalar_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8AN9g$0{?we&rcLF6drV05L6%#J#df{t_Ma?QO}xiS;18dH`27zvTc}|PWofnH6f9ML`)M+c>cZkI=i@t!OmgYzSpnsec#tF'
        'jbHnXq#of>HQ<)#DY3#Rnyb&0<sv1SE-G!66A<q0I^#3vjrcUE1f0W@6F7!em?R}FFuv?*FQa8@Rq9LS(gSTWk?v+Rrv}0_=?P<%'
        'E<q+?YHu_@hxSA}IfWAlvxGWl6!T74*oT`6`jZ4<a!ZMvj|-V0oH|NetnQ}cl~ILqs)reOwsK9~-@VKdrX0yd*>w`yD+rlU>qw!w'
        '0J#(%bS{s_W9eIrZO0I{k$i=Z5SEB_wB*$At3clnr=VRV#q)UafuWhh_ASz~HJT&F_l4x@xVX4T+7qV;>zSMk%~BjW%nJ>|bp|29'
        'Z5kG@utwNmD8(_zRk>iX8!jp%GU^0}vv8jrsJ`H&(#8?RVJ9pQt39fOfn1P^Vy$5+{&K~z&JHTy@5J46<YwY2-Ys>Mx@mk_3RJam'
        'q|G6O`HE(Tv@7^p<b16ffZPl-)-xo|=cs2`t~|?CMvUnCJk~ST3Zu=Tbs*fb3PGcNP~O@=5axy!N;lH=G{S?6OfM2iEtYIV>7vFx'
        'g}G<)v22C;nuVctOAJRlwf=ucb7WHy9@aDvr-{+p)kqe*L;2TRazj3o&*clbiQh~4O1`d3X%LoU6RVew8!L~6x$A2Pci$-Yu3qor'
        'a^$^mo9GI{%1t14P%w=QV&~hU(CFvrn)j73)M+zzaFb+G;j54z!d!=PuFCE|NpdencYKa553WZMp+|Es;0LtYD?cs6r&|qypgrvw'
        'wp*w&J`SAFew<8^T4x$h&k)hCXj#AR9nUQDEd32(yfiv!1ONa'
    )

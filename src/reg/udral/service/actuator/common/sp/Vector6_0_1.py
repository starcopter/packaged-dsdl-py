...
#
# Source file:
# /home/runner/work/packaged-dsdl-py/packaged-dsdl-py/submodules/public_regulated_data_types/reg/udral/service/actuator/common/sp/Vector6.0.1.dsdl
#
# Generated at:  2025-09-11 16:20:09.405178 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Vector6_0_1:
    ...
    _MODEL_: _pydsdl_.DelimitedType = _restore_constant_(
        'ABzY8x%R?n0{^8{TW=dh6n4@iPLl>)0_g(}^#hlH=yH)jAP^E1!eyJ(I5bE=n9S~+_>8=}vznO=Hc}<}0BWR>sFdOV@lW8)uHD3K'
        'jD)ad?Rd|bbNSBqonM#!{G#2eKkjBZ7Di+dGoU5U<S#tQAY!S?OJ$@5?>0VzOy+bH-;PW0Xa2PZ{=VOKD@+yzXpb$ov2S&i+DgN$'
        '%Q7o?P9fgVFo-Ilc@|Nc6PZH9$(>uJBg&MkA~I!k04cqA&%0H20@_GbgxKwa$@$F3t$5*g|G>L-#;w&dsVo?O=;t-@*vY%)9SNB@'
        'uWXG8ZaK4|T=(Lf>ss@%chB$05r{ib3@m;UUd{Hn!61Vi3Ofllr<PI&4CM)VT;0hOx3f{!St2dV>LfnyP<<&kmgP!-$D3}eH@zON'
        'MYqYe8%zO{-+Z5nWXAGBa4jwddPs3{J}9KEL`ZzB33kHL5XL)`GsW2b>+b+;-&cvdN{LIJN;~%Pid$kyM$WHHdpeIz?b#>)dw1<q'
        'X&a>W>F=aFcZI3ayY9RoW}GJ~lc{%`yO1kFEYx+k1RV%+k#H$W8X|t+p6f#iR$lJ6$c9uqeoTJP?p0aF_4r9Aigm)X3j7~_JMKI('
        '33a~2a#{HJC>;1G9NGc@D&uq^UI?D8M}`oEQOS#%l6zGWuHu?oZo<)Bp{S7-LCM|b1)8#C+=$`6#~yAOnz(>cL&`~5{?t9gjswkD'
        'skCKM_&s->8CB^N$dCamInC3x!y}Uk&9X=G9QDH6GwONaP0Ecbh;2nzwJzP#&q@!y>(Drdd;sEBfd5uG_Q>3tsgk-m5)kpfN(g^O'
        'Dy43zo^x@K^$NWv0oC%Q3MK+322CYQDH{=cw`ge4or#d6x1zVBkki{h(M^WjP#-#IWg6uazrnui)X+3bryz3>_4a>H+@5X_a5rke'
        'm{m+GW$W;Ua3C>#zl}fOk9debA*1gRa!f*f_zu2Xa|7SU4;v;m6zXvyWHES(XJq||R#n-UeY{FU_&Pqqn0|LC%-zTAz;(Qa9lU<%'
        'af{>rgaLT(6c6_ByGtv=6a@kv;{dU)ZdfCQ+5ZFvtGNIW-C<-2eZSl4xGkb*v-UMZ;DR3Yexqfyd5_pXC_sEwSQvnw*<|=q+{Ksi'
        ')p#N7C4BuM0Wb&I7jCN}(7(7;?_m=Kxf5Li8}Rcc#Fs&bT~h2!s2hD=4B+3E!U`MKvfgbi(v6G3R%`jw=vo+4=V5m7>O}4J5Wxg%'
        'm#p1Otl@I>4?KxpSW*W700'
    )
